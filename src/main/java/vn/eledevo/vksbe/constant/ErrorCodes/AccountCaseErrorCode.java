...
@Getter
public enum AccountCaseErrorCode implements BaseErrorCode {
    ACCOUNT_CASE_NOT_FOUND(OK, "ACC-C", "Tài khoản này đã bị gỡ ra khỏi vụ án", new HashMap<>()),
    ;
    ...
    AccountCaseErrorCode(HttpStatusCode statusCode, String code, String message, Map<String, Optional<?>> result) {
        this.code = code;
