...
public enum ComputerErrorCode implements BaseErrorCode {
    ...
    NOT_REMOVE_ROLE_IT_ADMIN(OK, "COM-04", "Không thể thao tác thiết bị của IT-Admin khác", new HashMap<>()),
    NOT_FOUND(OK, "COM-05", "Thiết bị không tồn tại trong hệ thống. Vui lòng kiểm tra lại", new HashMap<>()),
    ;
